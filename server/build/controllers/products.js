...
var createProduct = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var _req$files, _req$body, name, description, type, price, sku, sizes, outstanding, sold, product, _yield$uploadImage, public_id, secure_url;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _req$body = req.body, name = _req$body.name, description = _req$body.description, type = _req$body.type, price = _req$body.price, sku = _req$body.sku, sizes = _req$body.sizes, outstanding = _req$body.outstanding, sold = _req$body.sold;
        ...
        case 6:
          _yield$uploadImage = _context3.sent;
          public_id = _yield$uploadImage.public_id;
          secure_url = _yield$uploadImage.secure_url;
          product.image = {
            public_id: public_id,
            secure_url: secure_url
          };
          _context3.next = 12;
          return (0, _fsExtra.unlink)(req.files.image.tempFilePath);
        case 12:
          _context3.next = 14;
          return product.save();
        case 14:
  ...
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 6:
          if (!((_req$files2 = req.files) !== null && _req$files2 !== void 0 && _req$files2.image)) {
            _context4.next = 11;
            break;
          }
          _context4.next = 9;
